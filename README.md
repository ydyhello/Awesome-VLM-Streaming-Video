...
|Date|Title|Paper|Code|Comment|
|:---:|:---:|:---:|:---:|:---:|
|2026.05|MuKV: Multi-Grained KV Cache Compression for Long Streaming Video Question-Answering|[[pdf]](https://arxiv.org/pdf/2605.22269)|[[GitHub]](https://github.com/IMBALDY/MuKV) ![](https://img.shields.io/github/stars/IMBALDY/MuKV.svg?style=social)|Multi-Grained KV-Cache Compression at Patch, Frame & Segment Levels with Attention- and Frequency-Guided Token Selection; Semi-Hierarchical Retrieval for Online QA |
